#!/usr/bin/env python3
"""
Irvine Public Library scraper - Library of Things
...
CATALOG_URL = "https://irvinepl.ent.sirsi.net/client/en_US/default/search/results?te=&lm=LOT"
...
def scrape_catalog():
    """Scrape items from Irvine Library SirsiDynix catalog"""
    print("Starting Irvine Public Library scrape...")
    print("=" * 60)
    ...
    try:
        ...
        with open('irvine_library_catalog.html', 'w', encoding='utf-8') as f:
            f.write(response.text)
        print("✓ Saved catalog page to irvine_library_catalog.html\n")
...
def main():
    ...
    # Save to file
    output_file = "irvine_library_data.json"
